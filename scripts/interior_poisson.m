...
n = 600;     % Number of quadrature nodes on Gamma & Gamma'
M = 20;
m = 20;      % Number of radial Chebyshev nodes in strip
nbulk = 324; % Number of uniform nodes for bulk FFT solve

Gamma = Boundary.star(n, 'wobble', 0.2);
...
[Gamma1, xyfun] = perturb(Gamma, radial_width, dom_strip);
xfun = real(xyfun);
yfun = imag(xyfun);
