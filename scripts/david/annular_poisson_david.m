...
Gamma1 = perturb(Gamma, sgn*radial_width);
...
%% Plot the errors
clf
xf = chebfun2(radial_x, [0 2*pi 0 1], 'trigx', 'chebkind', chebkind);
yf = chebfun2(radial_y, [0 2*pi 0 1], 'trigx', 'chebkind', chebkind);
hold on
surf(xf(tt,rr), yf(tt,rr), log10(abs(uu-ss)))
%surf(xf(tt,rr), yf(tt,rr), ss)
