classdef StripSolver < handle
%STRIPSOLVER   A strip solver around a closed curve.
    ...
    properties ( Access = public )
        ...
        patches = {}  % Cell array of StripSolver.Patches.
    ...
    methods
        ...
        function obj = StripSolver(dom, rhs)
        %STRIPSOLVER   Constructor for the STRIPSOLVER class.
            ...
            % Build merge indices:
            obj.mergeIdx = StripSolver.defaultIdx(dom);
